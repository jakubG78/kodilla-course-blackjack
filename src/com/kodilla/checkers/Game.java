        ...
        for (int y = 0; y < 8; y++) {
            for (int x = 0; x < 8; x++) {
                ...
                if (figure.getColor() == FigureColor.BLACK && figure instanceof PawnFigure)
                    gridPane.add(new ImageView(new Image("file:resources/testField/pieces/black_pawn.png")),x,y);
                else if (figure.getColor() == FigureColor.BLACK && figure instanceof QueenFigure)
                    gridPane.add(new ImageView(new Image("file:resources/testField/pieces/black_queen.png")),x,y);
                else if (figure.getColor() == FigureColor.WHITE && figure instanceof PawnFigure)
                    gridPane.add(new ImageView(new Image("file:resources/testField/pieces/white_pawn.png")),x,y);
                else if (figure.getColor() == FigureColor.WHITE && figure instanceof QueenFigure)
                    gridPane.add(new ImageView(new Image("file:resources/testField/pieces/white_queen.png")),x,y);
            }
        }
    }
